...
define('DB_CONFIG_DIR', 'C:/wamp/www/140dev/db/');

// Server path for scripts within the framework to reference each other
define('CODE_DIR', 'C:/wamp/www/140dev/');
...
define('STREAM_ACCOUNT', 'only4omkar');
define('STREAM_PASSWORD', '3ditwittergit5');
...
define('TWEET_ERROR_ADDRESS','go2omkar@yahoo.co.in');
?>